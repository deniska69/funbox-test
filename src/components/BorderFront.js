import './BorderFront.css';

const BorderFront = props => {
  return (
    <svg width="320" height="480" viewBox="0 0 320 480" fill="none" xmlns="http://www.w3.org/2000/svg" className="borderFront">
      ...
      <path
        className="borderFrontFill"
        id={'borderFront_' + props.id}
